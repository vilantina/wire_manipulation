...
class RGBDSegmentation(object):
    ...
    def rgb_callback(self, data, args):
        ...
        purple_lower_color = np.array([100, 30, 30])  # Adjust values as needed
    ...
    def offset_threshold(self, min_col, min_row, max_col, max_row):
        ...
        min_horizontal_offset_threshold = 1280 * 0.02 
        min_vertical_offset_threshold = 720 * 0.02
        max_horizontal_offset_threshold = 1280 * 0.15 
        max_vertical_offset_threshold = 720 * 0.15
