...
class PoseTransformationCalculator(object):
    ...
    def current_pose_save(self):
        ...
        try:
            pose_transform = tfBuffer.lookup_transform('b_bot_ee_arm_link', 'd435i_link', rospy.Time())
            new_pose = Pose()
    ...
    def compute_transform_difference(self, pose_0_index=0, pose_1_index=1):
        ...
        relative_transform = np.dot(np.linalg.inv(self.poses[pose_0_index]), self.poses[pose_1_index])
