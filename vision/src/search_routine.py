...
class SearchRoutine():
    ...
    def search(self, check_subnodes : bool):
        ...
        while SEARCHING:
            ...
            if self.check_frame_found("d435i_color_frame", 'line_grasp_mounted_cam', pos,ori):
                ...
                while node_variation_counter < len(NODE_POS_OFFSETS):
                    ...
                    if self.check_frame_found("d435i_color_frame", 'usb-line_grasp_mounted_cam', pos, ori):
                        SEARCHING = False # end search when aruco found
                        TAG_FOUND = True
                        break
                    else:
